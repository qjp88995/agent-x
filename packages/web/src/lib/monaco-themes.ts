...
export const agentxLight: MonacoThemeData = {
  ...
  colors: {
    ...
    'editorWidget.background': '#FDFDFF',
    'editorWidget.border': '#E2E0F0',
    'editorSuggestWidget.background': '#FDFDFF',
...
export const agentxDark: MonacoThemeData = {
  ...
  colors: {
    ...
    'editorWidget.background': '#0F101C',
    'editorWidget.border': '#2A2750',
    'editorSuggestWidget.background': '#0F101C',
